package core.planning.core.mobsim.passivePlanning.agents;

import java.util.List;
import java.util.concurrent.atomic.AtomicInteger;

import core.planning.api.population.EmptyTime;
import core.planning.core.mobsim.passivePlanning.definitions.SinglePlannerAgent;
...
public abstract class SinglePlannerAgentImpl implements SinglePlannerAgent {
	...
	@Override
	public int planLegActivityLeg(double startTime, PassivePlannerManager.CurrentTime now, Id<ActivityFacility> startFacilityId, double endTime, Id<ActivityFacility> endFacilityId, final PassivePlannerManager.MobsimStatus mobsimStatus) {
	...
	protected abstract List<? extends PlanElement> getLegActivityLeg(double startTime, PassivePlannerManager.CurrentTime now, Id<ActivityFacility> startFacilityId, double endTime, Id<ActivityFacility> endFacilityId, final PassivePlannerManager.MobsimStatus mobsimStatus);
	@Override
