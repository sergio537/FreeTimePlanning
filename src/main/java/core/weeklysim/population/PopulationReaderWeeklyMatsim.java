...
package core.weeklysim.population;
...
import core.planning.core.population.BasePersonImpl;
 ...
 * @author balmermi
 */
public class PopulationReaderWeeklyMatsim extends MatsimXmlParser implements PopulationReader {
	...
	public PopulationReaderWeeklyMatsim(final Scenario scenario) {
